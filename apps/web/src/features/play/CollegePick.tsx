        ...
        {pick.schools.map((s) => {
          ...
          return (
            <button
              ...
              className="flex flex-col rounded-2xl border border-court-700 bg-court-900 p-4 text-left transition-colors hover:border-amber hover:bg-amber/4"
            >
              {crest && <img src={crest} alt="" className="mb-2 h-10 w-10 object-contain" />}
